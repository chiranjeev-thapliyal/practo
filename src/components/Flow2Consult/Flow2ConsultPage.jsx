              ...
              {!more && (
                <div className={styles.flex12}>
                  ...
                  <div className={styles.PatientHeader}>
                    ...
                    <div
                      className={`${styles.inputFullNameBox} ${styles.numberBox}`}
                    >
                      <svg
                        width="24"
                        height="24"
                      ...
                      >
                        <g clipPath="url(#clip0)">
                          ...
                          />
                          <path
                            d="M0 8.66699H24V15.3337H0V8.66699Z"
                            fill="#EEEEEE"
                          />
                          <path
          ...
          <div className={styles.flexBox}>
            <div className={styles.flex2}>
              <div className={styles.flex12}>
                ...
                <div className={styles.PatientHeader}>
                  <div className={styles.fullNameLabel}>
                    Verified Pediatricians online now
                  </div>
                  <div className={styles.ballIconBox}>
                    <div className={StyleSheet.ballIconContainer}>
                      <i className={`ion-help-buoy ${styles.iconBall}`}></i>
                      <i className={`ion-help-buoy ${styles.iconBall}`}></i>
                      <i className={`ion-help-buoy ${styles.iconBall}`}></i>
                      <i className={`ion-help-buoy ${styles.iconBall}`}></i>
                    </div>
